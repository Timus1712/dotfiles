...
config_dir = ("/home/timus/.config/awesome/")
...
local strf = '<span font="' .. font .. '" color="#EEEEEE" background="#777E76">%a %b %d %H:%M </span>'
...
my_cal = blingbling.calendar({widget=tdwidget})
--my_cal:set_current_day_widget_style({text_color="#EEEEEE", background_color="#777E76"})

--{{ Wifi ssid Widget }} --
netwidget = wibox.widget.textbox()
vicious.register(netwidget, vicious.widgets.wifi, function(widget, args)
    return '<span background="#C2C2A4" font="Inconsolata 11"> <span font ="Inconsolata 11" color="#FFFFFF">'..args["{ssid}"]..' </span></span>' end, 30, 'wlp3s0')
...
'<span background="#D0785D" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE">${/ avail_gb}|${/home avail_gb} GB </span></span>',
800)

udisk_glue = blingbling.udisks_glue({menu_icon=beautiful.fsicon})
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 11"><span font="Inconsolata 11" color="#FFFFFF" background="#92B0A0">$1$2% ($3)</span></span>', 30, "BAT0" )
...
'<span background="#4B696D" font="Inconsolata 11"><span font="Inconsolata 11" color="#DDDDDD">$2%·$3%·$4%·$5%<span color="#888888">·</span></span></span>', 5)
...
kbdcfg = {}
kbdcfg.render = function(arg)
	return '<span background="#313131" font="Inconsolata 11"><span font ="Inconsolata 11" color="#AAAAAA">'..arg..'</span></span>'
end
kbdcfg.cmd = "setxkbmap"
kbdcfg.layout = { { "us", "" , "us" }, { "ru", "" , "ru" } }
kbdcfg.current = 1  -- us is our default layout
kbdcfg.widget = wibox.widget.textbox()
kbdcfg.widget:set_markup(kbdcfg.render(kbdcfg.layout[kbdcfg.current][3]))
